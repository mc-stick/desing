      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: "var(--text-secondary)" }}>
              <li className="hover:text-red-500 cursor-pointer transition-colors">Rigging</li>
              <li className="hover:text-red-500 cursor-pointer transition-colors">Modeling</li>
              <li className="hover:text-red-500 cursor-pointer transition-colors">Drawing</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {[
                {
                  name: `${BRAND_NAME} en X`,
                  link: "https://x.com/EdwardUrena_h",
                  icon: (
                ...
                // },
                {
                  name: `${BRAND_NAME} en Instagram`,
                  link: "https://www.instagram.com/edwardurena12/",
                  icon: (
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                {
                  name: `${BRAND_NAME} en YouTube`,
                  link: "https://www.youtube.com/@edwardurena1136",
                  icon: (
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                //   icon: (
                //     <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                //       <path d="M20.5 3.5A11.8 11.8 0 0 0 12 0 11.9 11.9 0 0 0 1.6 17.7L0 24l6.4-1.6A11.9 11.9 0 0 0 12 24a12 12 0 0 0 8.5-20.5z" />
                //     </svg>
                //   )
                // }
              ].map((item, i) => (
